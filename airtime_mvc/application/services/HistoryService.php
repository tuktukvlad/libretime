...
class Application_Service_HistoryService
{
	...
	public function getFileMetadataTypes() {
		...
		$fileMD = array(
			...
			array("name"=> MDATA_KEY_ID, "label"=> _("ID"), "type"=> TEMPLATE_INT),
	...
	private function defaultItemTemplate() {
		...
		$fields[] = array("name" => MDATA_KEY_ID, "label"=> _("ID"), "type" => TEMPLATE_INT, "isFileMd" => true); //these fields can be populated from an associated file.
